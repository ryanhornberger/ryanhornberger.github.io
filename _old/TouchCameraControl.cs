...
public class TouchCameraControl : MonoBehaviour {
	...
	void Start () 
	{
		...
		Debug.Log ("Camera Orthographic Size: " + _camera.orthographicSize);
		Debug.Log ("Screen W/H: " + new Vector2 (Screen.width,Screen.height));
		Debug.Log ("Camera Viewsize: " + new Vector2 (_camera.pixelWidth, _camera.pixelHeight));
